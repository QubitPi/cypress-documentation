...
In general, it is a good strategy to confine all CI/CD logics, including tests, in one realm. To have everything
contained in GitHub Action, please use this
[reusable workflow](https://github.com/QubitPi/github-management#cypress-e2e-tests-in-parallel-with-spec-file-granularity)
as an alternative to the Cypress Cloud
